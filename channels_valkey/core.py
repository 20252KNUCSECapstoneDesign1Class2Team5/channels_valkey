...
class ValkeyChannelLayer(BaseChannelLayer):
    ...
    def _map_channel_keys_to_connection(self, channel_names, message):
        ...
        # Message dict maps valkey key to the message that needs to be send on that key
        ...
        # Now that we know what message needs to be send on a valkey key we serialize it
